...
export default function Root() {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col gap-y-10 justify-center items-center">
            <span className="text-6xl font-light text-gray-900">You are signed in as {currentUser.name}!</span>
            {currentUser && (
                <Form method="post" onSubmit={handleLogout} className="w-full flex justify-center">
                    <button
                        type="submit"
